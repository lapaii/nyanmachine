...
the nyassembler and nyantime are now compliant with the spec in how it functions and the instructions available!

check the `extra` branch as i am still working on this project but adding more functionality to it!
